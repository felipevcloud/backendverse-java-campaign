...
**Playbook vigente:** Backendverse Playbook v1.5
**Curriculum vigente:** Backendverse Curriculum v1.5
...
* Playbook v1.5 é a versão metodológica final;
* todo Episode operacional termina com mini-boss planejado e sem API surpresa;
* o currículo cobre os eixos obrigatórios para Java Backend Junior e nomeia o destino de cada lacuna;
* estado mutável existe somente neste arquivo;
* documentação é consolidada apenas no encerramento, cancelamento ou auditoria.

## Regra de manutenção

Este arquivo é um snapshot, não um diário. Não muda em `MISSION START`, respostas, blocos, pausas ou retomadas. Quando houver código, sua única atualização acompanha o commit final da missão.
